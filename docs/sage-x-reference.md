...
- **Investment & AI news:** [`/investment`](../app/investment/page.tsx) — after the intro video, the scene uses the same 4×6 grid and player controls as [`/map`](../app/map/page.tsx) ([`news_backgroung_chunks/`](../public/assests/background/investement/news_backgroung_chunks/) + [`NewsMapPlayfield`](../components/NewsMapPlayfield.tsx)). Collisions: [`newsMapCollisions.json`](../src/data/newsMapCollisions.json) (neon cyan debug rects).
